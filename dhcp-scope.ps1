...
#Set-DhcpServerv4OptionValue -ScopeId 192.168.30.0 -Router $Router

# Set DNS servers for the scope
#Set-DhcpServerv4OptionValue -ScopeId 192.168.30.0 -DNSServer $DNS1,$DNS2
